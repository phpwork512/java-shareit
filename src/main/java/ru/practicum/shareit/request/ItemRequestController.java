...
public class ItemRequestController {
    ...
    @GetMapping
    @ResponseStatus(HttpStatus.OK)
    public List<ItemRequestDto> getOwn(@RequestHeader(value = X_HEADER_NAME, defaultValue = "0") long requestAuthorId) {
    ...
    @ResponseStatus(HttpStatus.OK)
    public ItemRequestDto getById(@PathVariable int requestId, @RequestHeader(value = X_HEADER_NAME, defaultValue = "0") long userId) {
